...
public abstract class ImageLoader {
   ...
   *          A FragmentManager to use to retain the cache over configuration
  ...
  private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
    ...
    protected Bitmap doInBackground(Object... params) {
      ...
      // If the task has not been cancelled by another thread and the ImageView
      // that was
      // originally bound to this task is still bound back to this task and our
      // "exit early"
      // flag is not set, then call the main process method (as implemented by a
      // subclass)
