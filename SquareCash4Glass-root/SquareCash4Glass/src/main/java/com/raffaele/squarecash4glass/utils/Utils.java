...
import com.raffaele.squarecash4glass.ContactActivity;
...
public class Utils {
   ...
   * application and is useful for finding some potential bugs or best practice
   * violations.
   */
  @TargetApi(11)
  public static void enableStrictMode() {
    ...
    if (Utils.hasGingerbread()) {
      ...
      if (Utils.hasHoneycomb()) {
        ...
        vmPolicyBuilder.setClassInstanceLimit(ContactActivity.class, 1);
