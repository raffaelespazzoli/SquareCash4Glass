...
public class ContactsListActivity extends FragmentActivity implements ContactsListFragment.OnContactsInteractionListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    if (BuildConfig.DEBUG) {
      com.raffaele.squarecash4glass.utils.Utils.enableStrictMode();
    }
    super.onCreate(savedInstanceState);

    // Set main content view. On smaller screen devices this is a single pane
    // view with one
    ...
    //
    // // Fetch query from intent and notify the fragment that it should display
    // search
    ...
    //
    // // This flag notes that the Activity is doing a search, and so the result
    // will be
    // // search results rather than all contacts. This prevents the Activity
    // and Fragment
    ...
    // String title = getString(R.string.contacts_list_search_results_title,
    // searchQuery);
    // setTitle(title);
    // }
  ...
  public void onContactSelected(Uri contactUri) {
    ...
    // // If two pane layout then update the detail fragment to show the
    // selected contact
